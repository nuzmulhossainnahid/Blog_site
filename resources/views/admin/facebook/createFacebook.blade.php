        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Create Facebook Link</h4>
                            <a href="{{url('facebook')}}">
                                <button type="button" class="btn btn-info font-weight-bold" style="background-color: #2caae1"> Go Back Facebook Link </button>
                            </a>
                            <form class="forms-sample" action="{{url('createFacebookFrom')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="link" id="exampleTextarea1" rows="4"></textarea>
                                </div>
